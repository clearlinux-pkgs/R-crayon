...
Version  : 1.5.2
Release  : 97
URL      : https://cran.r-project.org/src/contrib/crayon_1.5.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/crayon_1.5.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664559271
