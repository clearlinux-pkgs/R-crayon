...
Version  : 1.4.0
Release  : 71
URL      : https://cran.r-project.org/src/contrib/crayon_1.4.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/crayon_1.4.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612037599
